...
/* Cree les points b, c et d entre deux extremites a et e d'un segment */
...
void generer_koch(struct list *koch, uint32_t nb_iterations)
{
    ...
    for (uint32_t i = 0; i < nb_iterations; i++) {
        ...
        // On fait le tour du flocon, segment par segment
        while (e != NULL) {
            // On cree les points
...
// On suit l'algorithme de Bresenham
